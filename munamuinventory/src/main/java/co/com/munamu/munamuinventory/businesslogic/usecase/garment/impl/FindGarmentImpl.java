...
import co.com.munamu.munamuinventory.businesslogic.usecase.garment.FindGarment;
...
public final class FindGarmentImpl implements FindGarment{
	...
	public void setDaoFactory(final DAOFactory daoFactory) {
		if(ObjectHelper.isNull(daoFactory)) {
			var userMessage = "Se ha presentado un problema inesperado tratando de llevar a cabo la busqueda de la prenda deseada. Por favor intente de nuevo y si el problema persiste, llame a los tecnicos";
			var technicalMessage = "El dao factory requerido para buscar la clase que busca la prenda llego nula.";
