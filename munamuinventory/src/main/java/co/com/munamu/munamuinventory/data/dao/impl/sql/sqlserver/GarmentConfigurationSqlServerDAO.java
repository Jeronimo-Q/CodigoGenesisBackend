...
public class GarmentConfigurationSqlServerDAO extends SqlDAO implements GarmentConfigurationDAO{
	...
	public List<GarmentConfigurationEntity> findByFilter(final GarmentConfigurationEntity filter) {
		...
		try(final var preparedStatement = getConnection().prepareStatement(statement.toString())){
			...
			while (result.next()) {
				...
				garmentConfigurationEntityTmp.setCategory((CategoryEntity) result.getObject("category"));
	...
	private void createWhere(final StringBuilder statemet, final GarmentConfigurationEntity filter, final ArrayList<Object> parameters) {
